...
function DoctorMessagesContent() {
    ...
    const activeConvRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(active);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorMessagesContent.useEffect": ()=>{
    ...
    const fetchConversations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DoctorMessagesContent.useCallback[fetchConversations]": async (initial = false)=>{
            if (!user) return;
            ...
            try {
                ...
                if (res.success) {
                    const sorted = [
                        ...
                        "DoctorMessagesContent.useCallback[fetchConversations].sorted": (a, b)=>new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime()
                    }["DoctorMessagesContent.useCallback[fetchConversations].sorted"]);
                    setConversations(sorted);
                    if (initial) {
                        const requested = searchParams.get('conversation');
                        const matched = requested ? sorted.find({
                            "DoctorMessagesContent.useCallback[fetchConversations]": (c)=>c.id === requested
                        }["DoctorMessagesContent.useCallback[fetchConversations]"]) : null;
    ...
    }["DoctorMessagesContent.useCallback[fetchConversations]"], [
        user,
        searchParams
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorMessagesContent.useEffect": ()=>{
            ...
            const id = setInterval({
                "DoctorMessagesContent.useEffect.id": ()=>fetchConversations(false)
            }["DoctorMessagesContent.useEffect.id"], 10_000);
            return ({
                "DoctorMessagesContent.useEffect": ()=>clearInterval(id)
            })["DoctorMessagesContent.useEffect"];
        }
    }["DoctorMessagesContent.useEffect"], [
        user,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorMessagesContent.useEffect": ()=>{
            ...
            if (!conv) return;
            setMessages([]);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].getMessages(conv.id).then({
                "DoctorMessagesContent.useEffect": (res)=>{
                    if (res.success) {
                        setMessages(res.data);
                        const lastFromPatient = [
                            ...res.data
                        ].reverse().find({
                            "DoctorMessagesContent.useEffect.lastFromPatient": (m)=>String(m.senderId) === String(conv.patientId)
                        }["DoctorMessagesContent.useEffect.lastFromPatient"]);
                        if (lastFromPatient) markOnline(conv.patientId);
                    }
                }
            }["DoctorMessagesContent.useEffect"]).catch({
                "DoctorMessagesContent.useEffect": ()=>{}
            }["DoctorMessagesContent.useEffect"]);
        }
    }["DoctorMessagesContent.useEffect"], [
                ...
                "DoctorMessagesContent.useEffect.connect": ()=>{
                    ...
                    ws.onopen = ({
                        "DoctorMessagesContent.useEffect.connect": ()=>{
                            ...
                            queue.forEach({
                                "DoctorMessagesContent.useEffect.connect": (msg)=>ws.send(msg)
                            }["DoctorMessagesContent.useEffect.connect"]);
                                ...
                                if (payload?.type === "chat.message") {
                                    ...
                                    setMessages({
                                        "DoctorMessagesContent.useEffect.connect": (prev)=>{
                                            if (payload.temp_id && payload.temp_id.startsWith(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPTIMISTIC_PREFIX"])) {
                                                ...
                                                if (alreadyReal) return prev.filter({
                                    ...
                                    setConversations({
                                        "DoctorMessagesContent.useEffect.connect": (prev)=>prev.map({
                                                "DoctorMessagesContent.useEffect.connect": (c)=>c.id === conv.id ? {
                                                        ...c,
                                                        lastMessage: mapped,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorMessagesContent.useEffect": ()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$appointmentService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["appointmentService"].getAppointments({
                ...
                "DoctorMessagesContent.useEffect": (res)=>{
                    if (res.success && res.data.length > 0) {
                        const upcoming = res.data.find({
                            "DoctorMessagesContent.useEffect.upcoming": (a)=>[
                                    'confirmed',
                                    'in-progress'
                                ].includes(a.status)
                        }["DoctorMessagesContent.useEffect.upcoming"]);
                ...
                "DoctorMessagesContent.useEffect": ()=>setActiveAppointment(null)
            }["DoctorMessagesContent.useEffect"]);
        }
    }["DoctorMessagesContent.useEffect"], [
        active?.id,
...
_s(DoctorMessagesContent, "i7jNMHKjubSwePo7Eu6EIz1B9JI=", false, function() {
    return [
...
//# sourceMappingURL=_333d63ce._.js.map