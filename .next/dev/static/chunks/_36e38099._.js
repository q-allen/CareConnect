                ...
                children: isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "No messages yet. Book a consultation to start chatting with your doctor!"
                        }, void 0, false, {
                            fileName: "[project]/src/components/chat/ConversationList.tsx",
                            lineNumber: 66,
                            columnNumber: 13
                    ...
                    children: conversations.map((conv)=>{
                        ...
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].button, {
                            ...
                            className: `w-full text-left p-4 border-b hover:bg-muted/50 transition-colors flex gap-3 ${isActive ? 'bg-muted' : ''}`,
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                conv.unreadCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                    className: "ml-2 h-5 min-w-5 px-1 flex items-center justify-center rounded-full text-xs shrink-0",
...
function VideoCallButton({ appointment, onStartCall }) {
    // Only show if there's an online appointment that's confirmed or in-progress
    if (!appointment || appointment.type !== 'online') return null;
    if (![
        'confirmed',
        'in-progress',
        'pending'
    ].includes(appointment.status)) return null;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
        onClick: onStartCall,
        size: "sm",
...
function ChatWindow({ conversation, appointment, onBack, onStartVideoCall }) {
    ...
    const { messages, addMessage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChatStore"])();
    ...
    const handleSend = async (e)=>{
        e.preventDefault();
        if (!text.trim() && !attachedFile || !user || isSending) return;
        const content = attachedFile ? `📎 ${attachedFile.name}` : text.trim();
        const type = attachedFile ? attachedFile.type.startsWith('image/') ? 'image' : 'file' : 'text';
        setIsSending(true);
        setText('');
        setAttachedFile(null);
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].sendMessage(conversation.id, user.id, user.role, content, type);
        if (res.success) {
            addMessage(res.data);
            // Simulate typing + auto-reply from doctor
            if (user.role === 'patient') {
                const delay = 5000 + Math.random() * 10000;
                setTimeout(()=>setIsTyping(true), delay - 3000 > 0 ? delay - 3000 : 0);
                setTimeout(async ()=>{
                    setIsTyping(false);
                    const docRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].sendMessage(conversation.id, conversation.doctorId, 'doctor', getAutoResponse(content));
                    if (docRes.success) addMessage(docRes.data);
                }, delay);
            }
        }
        setIsSending(false);
    ...
    const getAutoResponse = (userMsg)=>{
        ...
        if (lower.includes('pain') || lower.includes('hurt')) return "I'm sorry to hear you're in pain. Can you describe where exactly and how severe on a scale of 1-10?";
        if (lower.includes('prescription') || lower.includes('medicine')) return "I'll review your medication needs. Please make sure to complete your appointment for me to issue a formal prescription.";
        if (lower.includes('appointment') || lower.includes('schedule')) return "Your appointment details are confirmed. Let's discuss everything in detail during our video consultation.";
        if (lower.includes('result') || lower.includes('lab')) return "Thanks for sharing. I'll review the results and get back to you with my assessment shortly.";
        if (lower.includes('📎')) return "Thanks for sharing the file! I'll review it before our consultation.";
        const responses = [
            "Thank you for the update. I'll take note of this for our consultation.",
            "I understand. Let's discuss this in more detail during our scheduled video call.",
            "Got it! If symptoms worsen, please don't hesitate to reach out immediately.",
            "Thanks for letting me know. Please monitor and update me if anything changes.",
            "I've noted that. We can go through everything during our video consultation."
        ];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            appointment && appointment.type === 'online' && [
                'confirmed',
                'pending'
            ].includes(appointment.status) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                            type: "submit",
                            size: "icon",
                            disabled: !text.trim() && !attachedFile || isSending,
                            className: "shrink-0",
...
_s(ChatWindow, "9mQsRc1iEnT0rUnruE8cTcF24b8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"],
        ...
        setTimeout(()=>{
            setChatMsgs((prev)=>[
                    ...prev,
                    {
                        ...
                        sender: 'doctor',
                        text: 'I see, noted. Let me check your records.',
                        time: formatElapsed(elapsed + 5)
                    }
                ]);
        }, 4000);
    };
...
function MessagesPage() {
        ...
        "MessagesPage.useEffect": ()=>{
            ...
            if (convId && conversations.length > 0) {
                const conv = conversations.find({
                    "MessagesPage.useEffect.conv": (c)=>c.id === convId
                }["MessagesPage.useEffect.conv"]);
    ...
    const handleVideoCallEnd = (endedAt)=>{
        ...
        if (activeConversation && user) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].sendMessage(activeConversation.id, activeConversation.doctorId, 'doctor', '📋 Video consultation ended. Your prescription has been sent to your pharmacy. Get well soon!', 'text').then((res)=>{
                if (res.success) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].getMessages(activeConversation.id).then((msgRes)=>{
            ...
            addNotification({
                ...
                message: 'Your video consultation has ended. Check your messages for the prescription.',
                isRead: false,
                createdAt: endedAt
            });
        }
...
_s(MessagesPage, "JnH8TMfrFetxjg1r+P50y3mS4Pc=", false, function() {
    return [
...
//# sourceMappingURL=_36e38099._.js.map