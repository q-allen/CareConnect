...
function ChatWindow({ conversation, appointment, onBack, onStartVideoCall }) {
    ...
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const { messages, addMessage, removeMessage, reconcileOptimistic, isTyping, setTyping, conversations, setConversations, markMessageRead, markAllRead, setConversationUnread } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChatStore"])();
    ...
    const handleSend = async (e)=>{
        ...
        // ── Step 2: Add optimistic bubble (text AND file messages) ─────────────
        // For files, show a pending bubble with the filename so the user gets
        // immediate feedback during the upload. It is reconciled or rolled back
        // once the REST response arrives.
        ...
        try {
            ...
            // ── Step 4: Rollback on error — always safe now since optimisticMsg is never null
...
_s(MessagesContent, "LJm3mQx3KbmdSSbm35fK7tkDaag=", false, function() {
    return [
...
//# sourceMappingURL=_eb6ce841._.js.map