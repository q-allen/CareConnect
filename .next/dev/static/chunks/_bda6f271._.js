...
"[project]/src/services/paymentService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/api.ts [app-client] (ecmascript)");
;
const PAYMENTS_MODE = (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_PAYMENTS_MODE ?? (("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 'mock')).toLowerCase();
...
const mapBankInstructions = (data)=>{
...
const mapPaymentTransaction = (data)=>({
        ...
        method: data?.method ?? data?.payment_method ?? 'cod',
        ...
        bankInstructions: mapBankInstructions(data?.bankInstructions ?? data?.bank_instructions)
    });
   ...
   */ async processPayment (data) {
            ...
            if (data.method === 'gcash') {
                if (Math.random() < 0.1) {
                    return {
                        success: false,
                        data: null,
                        error: 'GCash payment failed. Please try again.'
                    };
                }
                const txn = {
                    id: txnId,
    ...
    async getPaymentStatus (txnId) {
        ...
        try {
            ...
            return {
                success: false,
                data: null,
                error: toErrorMessage(error, 'Unable to fetch payment status.')
            };
        }
    },
    async getPatientTransactions (patientId) {
        if (USE_MOCK_PAYMENTS) {
            return {
                success: true,
                data: mockTransactions.filter((t)=>t.patientId === patientId)
            };
        }
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].PAYMENTS_PATIENT(patientId));
            return {
                success: true,
                data: res.map(mapPaymentTransaction)
            };
        } catch (error) {
            return {
                success: false,
                data: [],
                error: toErrorMessage(error, 'Unable to load transactions.')
            };
        }
    },
    getDeliveryFee (province, subtotal) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$paymentService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/paymentService.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/store/index.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-toast.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils.ts [app-client] (ecmascript)");
;
...
function CheckoutPage() {
    ...
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    const { cart, cartTotal, cartCount, savedAddresses, selectedAddressId, selectedPaymentMethod, clearCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$pharmacyStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePharmacyStore"])();
    ...
    const { fee: deliveryFee } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$paymentService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["paymentService"].getDeliveryFee(province, subtotal);
    const grandTotal = subtotal + deliveryFee;
    const handlePlaceOrder = async ()=>{
        if (!selectedAddr || !user) return;
        setIsProcessing(true);
        // 1. Place order
        const orderRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$pharmacyService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pharmacyService"].placeOrder({
            patientId: user.id,
            items: cart,
        ...
        if (!orderRes.success) {
            ...
            toast({
                title: 'Order Failed',
                description: orderRes.error || 'Something went wrong.',
                variant: 'destructive'
            });
            return;
        }
        // 2. Process payment (for non-COD)
        let paymentTxn;
        if (selectedPaymentMethod !== 'cod') {
            const payRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$paymentService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["paymentService"].processPayment({
                orderId: orderRes.data.orderRef,
                patientId: user.id,
                amount: grandTotal,
            ...
            if (!payRes.success) {
                ...
                toast({
                    ...
                    description: payRes.error || 'Payment could not be processed.',
                    variant: 'destructive'
                });
                return;
            }
            paymentTxn = payRes.data;
        }
        setIsProcessing(false);
        clearCart();
        setOrderResult({
            orderRef: orderRes.data.orderRef,
            estimatedDelivery: orderRes.data.estimatedDelivery,
            totalAmount: grandTotal,
            paymentTransaction: paymentTxn
        });
        toast({
            title: 'Order placed! 🎉',
            description: `Order ${orderRes.data.orderRef} is now being processed.`
        });
    };
    ...
    // ─── ORDER CONFIRMATION ───
    if (orderResult) {
        const txn = orderResult.paymentTransaction;
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                    ...
                    children: [
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "font-medium",
                                                children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$paymentService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["paymentService"].getMethodLabel(selectedPaymentMethod)
                                            }, void 0, false, {
                                                fileName: "[project]/app/(patient)/patient/checkout/page.tsx",
                                                lineNumber: 130,
                                                columnNumber: 19
                        ...
                        selectedPaymentMethod === 'cod' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                        ...
                        txn?.method === 'gcash' && txn.status === 'success' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                            className: "border-success/30 bg-success/5",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                className: "p-4 text-left text-sm space-y-2",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "font-medium text-foreground",
                                        children: "✅ GCash Payment Successful"
                                    }, void 0, false, {
                                        fileName: "[project]/app/(patient)/patient/checkout/page.tsx",
                                        lineNumber: 161,
                                        columnNumber: 19
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                ...
                                                onClick: ()=>copyToClipboard(txn.referenceNumber),
                                                children: [
                        ...
                        txn?.method === 'bank' && txn.bankInstructions && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                            className: "border-warning/30 bg-warning/5",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                className: "p-4 text-left text-sm space-y-3",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "font-medium text-foreground",
                                                        children: txn.bankInstructions.bank
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/(patient)/patient/checkout/page.tsx",
                                                        lineNumber: 180,
                                                        columnNumber: 30
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "font-medium text-foreground",
                                                        children: txn.bankInstructions.accountNumber
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/(patient)/patient/checkout/page.tsx",
                                                        lineNumber: 181,
                                                        columnNumber: 33
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "font-medium text-foreground",
                                                        children: txn.bankInstructions.accountName
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/(patient)/patient/checkout/page.tsx",
                                                        lineNumber: 182,
                                                        columnNumber: 30
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                className: "font-bold text-foreground",
                                                                children: txn.bankInstructions.referenceCode
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/(patient)/patient/checkout/page.tsx",
                                                                lineNumber: 186,
                                                                columnNumber: 25
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                        ...
                                                        size: "sm",
                                                        className: "h-6 px-2",
                                                        onClick: ()=>copyToClipboard(txn.bankInstructions.referenceCode),
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$copy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Copy$3e$__["Copy"], {
                                                            className: "h-3 w-3"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/(patient)/patient/checkout/page.tsx",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "p-4 bg-primary/5 border border-primary/20 rounded-xl text-sm text-muted-foreground",
                            children: "📱 You'll be notified via SMS/email when your order is shipped."
                        }, void 0, false, {
                            fileName: "[project]/app/(patient)/patient/checkout/page.tsx",
                            lineNumber: 200,
                            columnNumber: 13
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        children: "Secure payment via PayMongo"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/(patient)/patient/checkout/page.tsx",
                                                                        lineNumber: 301,
                                                                        columnNumber: 25
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        children: [
                                                            "Delivery (",
                                                            province === 'Metro Manila' ? 'Metro' : 'Province',
                                                            ")"
                                                        ]
                                                    }, void 0, true, {
                                                        fileName: "[project]/app/(patient)/patient/checkout/page.tsx",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: deliveryFee === 0 ? 'text-success' : '',
...
_s(CheckoutPage, "JVsNTmh8M2Z1mTgESlJtPZKPF0U=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"],
...
//# sourceMappingURL=_bda6f271._.js.map