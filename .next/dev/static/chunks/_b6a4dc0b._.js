...
const authService = {
    ...
    async getMe () {
        try {
            ...
            if (res.user) return toFrontendUser(res.user);
            ...
            if (typeof document !== "undefined" && document.cookie.includes("user_role=")) {
                try {
                    ...
                    if (retry.user) return toFrontendUser(retry.user);
                } catch  {
...
function AuthRehydrator() {
    _s();
    const { user, setUser, setLoading, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthRehydrator.useEffect": ()=>{
            if (user) return;
            setLoading(true);
            // Try a silent refresh first so an expired access token doesn't cause
            // getMe() to return null when the refresh token is still valid.
...
_s(AuthRehydrator, "z21D/t7BfSJOOknoMpEQNDMZzEI=", false, function() {
    return [
...
//# sourceMappingURL=_b6a4dc0b._.js.map