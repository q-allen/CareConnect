...
function SignInPage() {
    ...
    const { user, setUser, setFamilyMembers } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    ...
    const isAuthLoading = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "SignInPage.useAuthStore[isAuthLoading]": (s)=>s.isLoading
    }["SignInPage.useAuthStore[isAuthLoading]"]);
    ...
    const handleLogin = async (event)=>{
        ...
        setIsLoading(true);
        try {
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].login({
                email,
                password
            });
            setUser(user);
            // Fetch full profile (including family members) after login
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].getMe().then((result)=>{
                if (result) {
                    setUser(result.user);
            ...
            toast({
                title: "Login failed",
                description: err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiError"] ? err.message : "Something went wrong.",
                variant: "destructive"
            });
        } finally{
            setIsLoading(false);
...
_s(SignInPage, "4ibWZVnOAmWQ/tPG4sVVJoZp/yc=", false, function() {
    return [
...
//# sourceMappingURL=_5720e642._.js.map