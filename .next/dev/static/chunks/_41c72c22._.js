...
"[project]/features/doctor/messages/actions.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function sendMessage(conversationId, senderId, content) {
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].sendMessage(conversationId, senderId, "doctor", content, "text");
    return res.data;
}
async function attachDocument(conversationId, senderId, documentId) {
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].sendMessage(conversationId, senderId, "doctor", documentId, "file");
    return res.data;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
"[project]/app/(doctor)/doctor/messages/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$messages$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/doctor/messages/actions.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function DoctorMessagesContent() {
    ...
    const [activeAppointment, setActiveAppointment] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [searchQuery, setSearchQuery] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [showList, setShowList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const [onlineMap, setOnlineMap] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorMessagesContent.useEffect": ()=>{
    ...
    const activeIdRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(active?.id);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorMessagesContent.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorMessagesContent.useEffect": ()=>{
            const fetch = {
                "DoctorMessagesContent.useEffect.fetch": async ()=>{
                    if (!user) return;
                    setLoadingList(true);
                    try {
                        ...
                        if (res.success) {
                            const sorted = [
                                ...
                                "DoctorMessagesContent.useEffect.fetch.sorted": (a, b)=>new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime()
                            }["DoctorMessagesContent.useEffect.fetch.sorted"]);
                            setConversations(sorted);
                            const requested = searchParams.get('conversation');
                            const matched = requested ? sorted.find({
                                "DoctorMessagesContent.useEffect.fetch": (c)=>c.id === requested
                            }["DoctorMessagesContent.useEffect.fetch"]) : null;
            ...
            }["DoctorMessagesContent.useEffect.fetch"];
            fetch();
        }
    }["DoctorMessagesContent.useEffect"], [
        user,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorMessagesContent.useEffect": ()=>{
            const loadMessages = {
                "DoctorMessagesContent.useEffect.loadMessages": async ()=>{
                    if (!active) return;
                    setLoadingChat(true);
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].getMessages(active.id);
                        if (res.success) {
                            setMessages(res.data);
                            const lastFromPatient = [
                                ...res.data
                            ].reverse().find({
                                "DoctorMessagesContent.useEffect.loadMessages.lastFromPatient": (m)=>m.senderId === active.patientId
                            }["DoctorMessagesContent.useEffect.loadMessages.lastFromPatient"]);
                            if (lastFromPatient) markOnline(active.patientId);
                        }
                    } catch  {
                    // backend unavailable
                    } finally{
            ...
            }["DoctorMessagesContent.useEffect.loadMessages"];
            loadMessages();
        }
    }["DoctorMessagesContent.useEffect"], [
        active?.id
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorMessagesContent.useEffect": ()=>{
            ...
            const connect = {
                "DoctorMessagesContent.useEffect.connect": ()=>{
                    const ws = new WebSocket(wsUrl);
                    wsRef.current = ws;
                    ws.onopen = ({
                        "DoctorMessagesContent.useEffect.connect": ()=>{
                            retryRef.current = 0;
                            // Mark all as read on (re)connect
                    ...
                    ws.onmessage = ({
                        "DoctorMessagesContent.useEffect.connect": (event)=>{
                            try {
                                ...
                                if (payload?.type === "chat.message") {
                                    const mapped = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$mappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mapMessage"])(payload, {
                                        conversationId: activeIdRef.current ?? active.id,
                                        patientId: active.patientId,
                                        doctorId: active.doctorId
                                    });
                                    if (mapped.senderId === active.patientId) {
                                        markOnline(active.patientId);
                                    }
                                    setMessages({
                                        "DoctorMessagesContent.useEffect.connect": (prev)=>{
                                            // Reconcile optimistic bubble if temp_id matches
                                            if (payload.temp_id && payload.temp_id.startsWith(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPTIMISTIC_PREFIX"])) {
                                                const alreadyReal = prev.some({
                                                    "DoctorMessagesContent.useEffect.connect.alreadyReal": (m)=>m.id === mapped.id
                                                }["DoctorMessagesContent.useEffect.connect.alreadyReal"]);
                                                if (alreadyReal) {
                                                    return prev.filter({
                                                        "DoctorMessagesContent.useEffect.connect": (m)=>m.id !== payload.temp_id
                                                    }["DoctorMessagesContent.useEffect.connect"]);
                                                }
                                                return prev.map({
                                                    "DoctorMessagesContent.useEffect.connect": (m)=>m.id === payload.temp_id ? mapped : m
                                                }["DoctorMessagesContent.useEffect.connect"]);
                                            }
                                            // Deduplicate by real id
                                            return prev.some({
                                                "DoctorMessagesContent.useEffect.connect": (m)=>m.id === mapped.id
                                            }["DoctorMessagesContent.useEffect.connect"]) ? prev : [
                                                ...prev,
                                                mapped
                                            ];
                                    ...
                                    setConversations({
                                        "DoctorMessagesContent.useEffect.connect": (prev)=>prev.map({
                                                "DoctorMessagesContent.useEffect.connect": (c)=>c.id === active.id ? {
                                                        ...c,
                                                        lastMessage: mapped,
                                    ...
                                    if (payload.user_id !== userIdRef.current) {
                                        ...
                                        if (payload.user_id === Number(active.patientId)) {
                                            markOnline(active.patientId);
                                        }
                                    }
                                }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorMessagesContent.useEffect": ()=>{
            const loadAppointment = {
                "DoctorMessagesContent.useEffect.loadAppointment": async ()=>{
                    ...
                    try {
                        ...
                        if (res.success && res.data.length > 0) {
                            const upcoming = res.data.find({
                                "DoctorMessagesContent.useEffect.loadAppointment.upcoming": (a)=>[
                                        'confirmed',
                                        'in-progress'
                                    ].includes(a.status)
                            }["DoctorMessagesContent.useEffect.loadAppointment.upcoming"]);
            ...
            }["DoctorMessagesContent.useEffect.loadAppointment"];
            loadAppointment();
        }
    }["DoctorMessagesContent.useEffect"], [
        active?.id,
    ...
    const handleSend = async (overrideContent)=>{
        ...
        const optimistic = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createOptimisticMessage"])(active.id, user.id, 'doctor', content, 'text');
        setMessages((prev)=>[
                ...prev,
                optimistic
            ]);
        try {
            if (wsReady) {
                // Step 3a: WS path — instant delivery
                ws.send(JSON.stringify({
                    type: "chat.message",
                    content,
                    msg_type: "text",
                ...
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].sendMessage(active.id, user.id, 'doctor', content, 'text');
                if (res.success) {
                    setMessages((prev)=>{
                        const alreadyReal = prev.some((m)=>m.id === res.data.id);
                        if (alreadyReal) return prev.filter((m)=>m.id !== optimistic.id);
    ...
    const sendDocs = async (payload)=>{
        ...
        try {
            if (payload.type === 'rx') {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$messages$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["attachDocument"])(active?.id || '', user.id, rx.id);
            }
            if (payload.type === 'lab') {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$messages$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["attachDocument"])(active?.id || '', user.id, lab.id);
            }
            if (payload.type === 'cert') {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$messages$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["attachDocument"])(active?.id || '', user.id, cert.id);
            }
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].sendMessage(active?.id || '', user.id, 'doctor', 'Document sent. Please check My Files.', 'file');
            toast({
                title: 'Document sent',
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DoctorMessagesContent.useMemo[filtered]": ()=>{
            if (!searchQuery) return conversations;
            const q = searchQuery.toLowerCase();
            return conversations.filter({
                "DoctorMessagesContent.useMemo[filtered]": (c)=>c.patient?.name?.toLowerCase().includes(q) || c.lastMessage?.content?.toLowerCase().includes(q)
            }["DoctorMessagesContent.useMemo[filtered]"]);
        }
    }["DoctorMessagesContent.useMemo[filtered]"], [
        conversations,
        ...
        children: [
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$scroll$2d$area$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollArea"], {
                            ...
                            children: !active ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                lineNumber: 538,
                                columnNumber: 15
                            }, this) : loadingChat ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-3",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Skeleton"], {
                                ...
                                children: [
                                    messages.map((msg)=>{
                                        ...
                                        const isPending = msg.id.startsWith(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPTIMISTIC_PREFIX"]);
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$doctor$2f$VideoConsultModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                onEnd: async ()=>{
                    setShowVideo(false);
                    if (active && user) {
                        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].sendMessage(active.id, user.id, 'doctor', 'Video consultation ended. Transcript saved.', 'text');
                    }
                    toast({
                        title: 'Consult ended',
...
_s(DoctorMessagesContent, "ELpafSf6mWhhpYgsflCRdzy9SPM=", false, function() {
    return [
...
_c = DoctorMessagesContent;
function DoctorMessagesPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DoctorMessagesContent, {}, void 0, false, {
            fileName: "[project]/app/(doctor)/doctor/messages/page.tsx",
            lineNumber: 666,
            columnNumber: 7
        }, this)
...
_c1 = DoctorMessagesPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "DoctorMessagesContent");
__turbopack_context__.k.register(_c1, "DoctorMessagesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_41c72c22._.js.map