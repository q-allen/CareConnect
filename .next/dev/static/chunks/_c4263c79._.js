...
"[project]/app/(patient)/patient/pharmacy/orders/success/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OrderSuccessPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OrderSuccessPage.useEffect": ()=>{
            ...
            const load = {
                "OrderSuccessPage.useEffect.load": async ()=>{
                    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$pharmacyService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pharmacyService"].getMyOrders();
                    if (res.success) {
                        const found = res.data.find({
                            "OrderSuccessPage.useEffect.load": (o)=>o.order_ref === ref
                        }["OrderSuccessPage.useEffect.load"]) ?? null;
                        setOrder(found);
                    }
                    setLoading(false);
                }
            }["OrderSuccessPage.useEffect.load"];
            load();
            // Re-poll after 3 s in case webhook hasn't fired yet
            const t = setTimeout(load, 3000);
            return ({
                "OrderSuccessPage.useEffect": ()=>clearTimeout(t)
            })["OrderSuccessPage.useEffect"];
        }
    }["OrderSuccessPage.useEffect"], [
        ref
...
_s(OrderSuccessPage, "PjW1cFpzZdxt10+XjT6i9lk62+U=", false, function() {
    return [
...
//# sourceMappingURL=_c4263c79._.js.map