...
function FileCard({ id, type, title, description, doctorName, doctorSpecialty, doctorAvatar, date, isNew, statusBadge, hasPrescriptionMeds, pdfUrl, fileUrl, index = 0, onClick }) {
    ...
    const fetchFile = async ()=>{
        ...
        if (type === 'prescription') {
            const res = await fetch(`${base}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].PRESCRIPTION_PDF(id)}`, {
                credentials: 'include'
            });
    ...
    const handleShare = async (e)=>{
        ...
        const base = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBaseUrl"])();
        const shareUrl = type === 'prescription' ? `${base}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].PRESCRIPTION_PDF(id)}` : (effectiveUrl?.startsWith('http') ? effectiveUrl : `${base}${effectiveUrl ?? ''}`) || window.location.href;
        try {
            if (navigator.share) {
...
//# sourceMappingURL=_eda90f6e._.js.map