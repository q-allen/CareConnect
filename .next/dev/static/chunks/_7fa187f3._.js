...
function getBaseUrl() {
    ...
    try {
        ...
        const isLocal = (url.hostname === "localhost" || url.hostname === "127.0.0.1") && (frontendHost === "localhost" || frontendHost === "127.0.0.1");
...
async function upload(path, body, method = "POST", _retry = true) {
    const baseUrl = getBaseUrl();
    const res = await fetch(`${baseUrl}${path}`, {
        method,
        credentials: "include",
    ...
    if (res.status === 401 && _retry) {
        try {
            await _refreshToken();
            return upload(path, body, method, false);
        } catch  {
            throw new ApiError(401, "Session expired. Please log in again.");
        }
    }
...
const API_ENDPOINTS = {
    ...
    PAYMENTS_STATUS: (id)=>`/api/payments/${id}/`,
    PAYMENTS_PATIENT: (id)=>`/api/payments/patient/${id}/`,
    // Notifications
...
;
function normalizeBackendUser(res) {
    return res?.user ?? res;
}
...
const userService = {
   ...
   */ async getCurrentUser () {
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].ME);
   ...
   */ async completePatientProfile (data) {
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].patch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].ME_COMPLETE, data);
            return {
                data: normalizeBackendUser(res),
                success: true
            };
        } catch (err) {
            return {
   ...
   */ async updateCurrentUser (data) {
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].patch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].ME, data);
            return {
                data: normalizeBackendUser(res),
                success: true
            };
   ...
   */ async uploadAvatar (file) {
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].upload(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].ME_AVATAR, form);
            return {
                data: res,
                success: true
            };
   ...
   */ async uploadHmoCard (provider, memberId, file) {
        try {
            const form = new FormData();
            form.append("provider", provider);
            form.append("member_id", memberId);
            if (file) form.append("card_image", file);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].upload("/api/patients/hmo/", form);
            return {
                data: undefined,
                success: true
            };
            ...
            return {
                data: null,
                success: false,
                error: err?.message ?? "Failed to save HMO card."
            };
        }
    }
};
...
function toFrontendUser(u) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$userService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mapBackendUser"])(u);
}
const authService = {
    async sendOtp (email) {
        ...
        try {
            ...
            if (res.user) {
                return {
                    ...
                    familyMembers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$userService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mapFamilyMembers"])(res.user.family_members ?? [])
                };
            }
            ...
            if (typeof document !== "undefined" && document.cookie.includes("user_role=")) {
                try {
                    ...
                    const retry = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].ME);
                    if (retry.user) {
                        return {
                            user: toFrontendUser(retry.user),
                            familyMembers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$userService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mapFamilyMembers"])(retry.user.family_members ?? [])
                        };
                    }
                } catch  {
    ...
    async inviteDoctor (data) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].DOCTOR_INVITE, data);
    },
    async activateDoctor (uid, token, password, password_confirm) {
...
const useAuthStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set)=>({
        ...
        updateUser: (patch)=>set((state)=>state.user ? {
                    user: {
                        ...state.user,
                        ...patch
                    }
        ...
        setProfileComplete: (complete)=>set((state)=>state.user ? {
                    user: {
                        ...state.user,
                        isProfileComplete: complete
                    }
                } : state),
        setDoctorProfileComplete: (complete)=>set((state)=>state.user ? {
                    user: {
                        ...state.user,
                        doctorProfileComplete: complete
                    }
                } : state),
        setFamilyMembers: (members)=>set({
        ...
        updateFamilyMember: (id, patch)=>set((state)=>({
                    familyMembers: state.familyMembers.map((m)=>m.id === id ? {
                            ...m,
                            ...patch
                        } : m)
                }))
...
const useNotificationStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set)=>({
        ...
        setNotifications: (notifications)=>{
            set((state)=>{
                ...
                const merged = notifications.map((n)=>localReadIds.has(n.id) ? {
                        ...n,
                        isRead: true
                    } : n);
                return {
...
const useChatStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        addMessage: (message)=>set((state)=>state.messages.some((m)=>m.id === message.id) ? state : {
                    messages: [
                        ...state.messages,
                        message
                    ]
        ...
        reconcileOptimistic: (tempId, realMessage)=>set((state)=>{
        ...
        markMessageRead: (messageId, readAt)=>set((state)=>({
        ...
        markAllRead: (conversationId)=>set((state)=>({
                    messages: state.messages.map((m)=>// Only mark messages that belong to this conversation and are unread
                        String(m.conversationId) === String(conversationId) && !m.isRead ? {
                            ...m,
                            isRead: true
                        } : m),
                    // Zero out unread count for this conversation
                    conversations: state.conversations.map((c)=>String(c.id) === String(conversationId) ? {
                            ...c,
                            unreadCount: 0
                        } : c)
                })),
        setConversationUnread: (conversationId, count)=>set((state)=>{
                const conversations = state.conversations.map((c)=>String(c.id) === String(conversationId) ? {
                        ...c,
                        unreadCount: count
                    } : c);
        ...
        recomputeTotalUnread: ()=>set((state)=>({
...
function AuthRehydrator() {
    _s();
    const { user, setUser, setLoading, logout, setFamilyMembers } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthRehydrator.useEffect": ()=>{
            if (user) return;
            setLoading(true);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].refresh().catch({
                "AuthRehydrator.useEffect": ()=>{}
            }["AuthRehydrator.useEffect"]).finally({
                "AuthRehydrator.useEffect": ()=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].getMe().then({
                        "AuthRehydrator.useEffect": (result)=>{
                            if (result) {
                                setUser(result.user);
    ...
    }["AuthRehydrator.useEffect"], []); // eslint-disable-line react-hooks/exhaustive-deps
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthRehydrator.useEffect": ()=>{
            ...
            const interval = setInterval({
                "AuthRehydrator.useEffect.interval": async ()=>{
                    try {
                        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].refresh();
                    } catch  {
                        logout();
                    }
                }
            }["AuthRehydrator.useEffect.interval"], 13 * 60 * 1000);
            return ({
                "AuthRehydrator.useEffect": ()=>clearInterval(interval)
            })["AuthRehydrator.useEffect"];
        }
    }["AuthRehydrator.useEffect"], [
        user,
...
_s(AuthRehydrator, "9fsPf8B7BoiCol/krqzsaP5//eA=", false, function() {
    return [
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$themes$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeProvider"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QueryClientProvider"], {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tooltip$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TooltipProvider"], {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthRehydrator, {}, void 0, false, {
...
_c1 = Providers;
var _c, _c1;
__turbopack_context__.k.register(_c, "AuthRehydrator");
...
//# sourceMappingURL=_7fa187f3._.js.map