...
"[project]/features/doctor/messages/data:407512 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
;
const $$RSC_SERVER_ACTION_0 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$client$2d$wrapper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createServerReference"])("70fee0dce18f060ec78c9701ccef2c48eda9cc926a", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$client$2d$wrapper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["callServer"], void 0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$client$2d$wrapper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findSourceMapURL"], "sendMessage");
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
"[project]/features/doctor/messages/data:05eedd [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
;
const $$RSC_SERVER_ACTION_1 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$client$2d$wrapper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createServerReference"])("7086cdf6fdfd851a02e9fbede8fa140cb2d5925ecf", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$client$2d$wrapper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["callServer"], void 0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$client$2d$wrapper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findSourceMapURL"], "attachDocument");
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$messages$2f$data$3a$407512__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/features/doctor/messages/data:407512 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$messages$2f$data$3a$05eedd__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/features/doctor/messages/data:05eedd [app-client] (ecmascript) <text/javascript>");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function DoctorMessagesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorMessagesPage.useEffect": ()=>{
            const fetch = {
                "DoctorMessagesPage.useEffect.fetch": async ()=>{
                    if (!user) return;
                    setLoadingList(true);
                    ...
                    if (res.success) {
                        const sorted = [
                            ...
                            "DoctorMessagesPage.useEffect.fetch.sorted": (a, b)=>new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime()
                        }["DoctorMessagesPage.useEffect.fetch.sorted"]);
                        setConversations(sorted);
                        const requested = searchParams.get('conversation');
                        const matched = requested ? sorted.find({
                            "DoctorMessagesPage.useEffect.fetch": (c)=>c.id === requested
                        }["DoctorMessagesPage.useEffect.fetch"]) : null;
            ...
            }["DoctorMessagesPage.useEffect.fetch"];
            fetch();
        }
    }["DoctorMessagesPage.useEffect"], [
        user,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorMessagesPage.useEffect": ()=>{
            const loadMessages = {
                "DoctorMessagesPage.useEffect.loadMessages": async ()=>{
                    if (!active) return;
                    setLoadingChat(true);
                    ...
                    if (res.success) {
                        ...
                        setReadIds({
                            "DoctorMessagesPage.useEffect.loadMessages": (prev)=>({
                                    ...prev,
                                    ...res.data.reduce({
                                        "DoctorMessagesPage.useEffect.loadMessages": (acc, msg)=>{
                                            acc[msg.id] = msg.senderId === user?.id ? true : acc[msg.id];
                                            return acc;
                                        }
                                    }["DoctorMessagesPage.useEffect.loadMessages"], {})
                                })
                        }["DoctorMessagesPage.useEffect.loadMessages"]);
                    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DoctorMessagesPage.useEffect": ()=>{
            const loadAppointment = {
                "DoctorMessagesPage.useEffect.loadAppointment": async ()=>{
                    ...
                    if (res.success && res.data.length > 0) {
                        const upcoming = res.data.find({
                            "DoctorMessagesPage.useEffect.loadAppointment.upcoming": (a)=>[
                                    'confirmed',
                                    'in-progress'
                                ].includes(a.status)
                        }["DoctorMessagesPage.useEffect.loadAppointment.upcoming"]);
                        setActiveAppointment(upcoming || res.data[0]);
                    } else {
                        setActiveAppointment(null);
                    }
                }
            }["DoctorMessagesPage.useEffect.loadAppointment"];
            loadAppointment();
        }
    }["DoctorMessagesPage.useEffect"], [
        active?.id,
    ...
    const handleSend = async (content)=>{
        ...
        if (!payload) return;
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].sendMessage(active.id, user.id, 'doctor', payload, 'text');
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$messages$2f$data$3a$407512__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["sendMessage"])(active.id, user.id, payload);
        if (res.success) {
            setMessages((prev)=>[
                    ...prev,
                    res.data
    ...
    const sendDocs = async (payload)=>{
        ...
        if (payload.type === 'rx') {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$messages$2f$data$3a$05eedd__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["attachDocument"])(active?.id || '', user.id, rx.id);
        }
        if (payload.type === 'lab') {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$messages$2f$data$3a$05eedd__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["attachDocument"])(active?.id || '', user.id, lab.id);
        }
        if (payload.type === 'cert') {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$messages$2f$data$3a$05eedd__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["attachDocument"])(active?.id || '', user.id, cert.id);
        }
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DoctorMessagesPage.useMemo[filtered]": ()=>{
            if (!searchQuery) return conversations;
            const q = searchQuery.toLowerCase();
            return conversations.filter({
                "DoctorMessagesPage.useMemo[filtered]": (c)=>c.patient?.name?.toLowerCase().includes(q) || c.lastMessage?.content?.toLowerCase().includes(q)
            }["DoctorMessagesPage.useMemo[filtered]"]);
        }
    }["DoctorMessagesPage.useMemo[filtered]"], [
        conversations,
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$doctor$2f$VideoConsultModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                onEnd: async ()=>{
                    setShowVideo(false);
                    if (active && user) {
                        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].sendMessage(active.id, user.id, 'doctor', 'Video consultation ended. Transcript saved.', 'system');
                    }
                    toast({
                        title: 'Consult ended',
...
_s(DoctorMessagesPage, "LuMYCAWLTHB4Za/SO/axkk1mpOo=", false, function() {
    return [
...
_c = DoctorMessagesPage;
var _c;
__turbopack_context__.k.register(_c, "DoctorMessagesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_1b255c52._.js.map