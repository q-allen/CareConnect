...
function DoctorPrescriptionsPage() {
    ...
    const [prefill, setPrefill] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    ...
    const handleIssue = async (payload)=>{
        ...
        try {
            ...
            if (convRes.success) {
                const note = payload.followUpDate ? `E-prescription sent. Follow-up scheduled on ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(payload.followUpDate), 'MMM d, yyyy')}. Please check My Files.` : 'E-prescription sent. Please check My Files.';
    ...
    const handlePrint = async ()=>{
        ...
        try {
            const { getBaseUrl } = await __turbopack_context__.A("[project]/src/services/api.ts [app-client] (ecmascript, async loader)");
...
_s(DoctorPrescriptionsPage, "mfYYnrj3Er9T+Fd4vC9KCTHIhN4=", false, function() {
    return [
...
//# sourceMappingURL=_166eb014._.js.map