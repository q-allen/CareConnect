...
// In-memory store
let reviews = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockReviews"]
];
const reviewService = {
    async getDoctorReviews (doctorId) {
        const doctorReviews = reviews.filter((r)=>r.doctorId === doctorId).map((r)=>({
                ...r,
                patient: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockPatients"].find((p)=>p.id === r.patientId)
            })).sort((a, b)=>new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiSuccess"])(doctorReviews);
    },
    async createReview (data) {
        // Check if review already exists for this appointment
        const existing = reviews.find((r)=>r.appointmentId === data.appointmentId);
        if (existing) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiError"])('Review already exists for this appointment');
        }
        const newReview = {
            id: `rev-${Date.now()}`,
            ...data,
...
function DoctorProfilePage() {
    ...
    const fetchDoctorData = async ()=>{
        ...
        const [doctorRes, reviewsRes] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$doctorService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doctorService"].getDoctorById(id),
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$reviewService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reviewService"].getDoctorReviews(id)
        ]);
    ...
    const handleStartChat = async ()=>{
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].createConversation(user.id, doctor.id);
        if (response.success) {
    ...
    const availableDates = Array.from({
        length: 7
    }, (_, i)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$addDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(new Date(), i));
    if (isLoading) {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                doctor.isOnDemand && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            ...
                                                            children: [
                                                                "Available Times — ",
                                                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(selectedDate, 'MMMM d')
                                                            ]
                                                        }, void 0, true, {
                                                            fileName: "[project]/app/(patient)/patient/doctors/[id]/page.tsx",
                                                            lineNumber: 407,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        !doctor.isAvailable && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(DoctorProfilePage, "rk1CMdrbdwSHzCbjaYJMCK/0mnk=", false, function() {
    return [
...
//# sourceMappingURL=_d1cdb933._.js.map