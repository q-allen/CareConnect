...
const locations = [
    'All Locations',
    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$phCities$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PH_CITIES"]
];
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    doctor.onlineConsultationFee ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    doctor.consultationFee ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex items-center gap-1 justify-end text-muted-foreground",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$building$2d$2$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Building2$3e$__["Building2"], {
                                                                className: "h-3 w-3"
...
function FindDoctorsContent() {
    ...
    const fetchDoctors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FindDoctorsContent.useCallback[fetchDoctors]": async ()=>{
            setIsLoading(true);
            try {
                const filters = {};
                ...
                if (response.success) {
                    ...
                    if (consultType === 'online') data = data.filter({
                        "FindDoctorsContent.useCallback[fetchDoctors]": (d)=>d.acceptsOnline
                    }["FindDoctorsContent.useCallback[fetchDoctors]"]);
                    if (consultType === 'in-clinic') data = data.filter({
                        "FindDoctorsContent.useCallback[fetchDoctors]": (d)=>d.acceptsInClinic
                    }["FindDoctorsContent.useCallback[fetchDoctors]"]);
                    // Apply client-side specialty filter (case-insensitive exact match)
                    if (specialty && specialty !== 'All Specialties') {
                        data = data.filter({
                            "FindDoctorsContent.useCallback[fetchDoctors]": (d)=>d.specialty?.toLowerCase() === specialty.toLowerCase()
                        }["FindDoctorsContent.useCallback[fetchDoctors]"]);
                    }
                    // Apply client-side location filter (case-insensitive match)
                    if (location && location !== 'All Locations') {
                        data = data.filter({
                            "FindDoctorsContent.useCallback[fetchDoctors]": (d)=>d.location?.toLowerCase().includes(location.toLowerCase())
                        }["FindDoctorsContent.useCallback[fetchDoctors]"]);
                    }
                    // Apply client-side max fee filter
                    if (maxFee < 2000) {
                        data = data.filter({
                            "FindDoctorsContent.useCallback[fetchDoctors]": (d)=>{
                    ...
                    if (onlyAvailable) {
                        data = data.filter({
                            "FindDoctorsContent.useCallback[fetchDoctors]": (d)=>d.isOnDemand === true
                        }["FindDoctorsContent.useCallback[fetchDoctors]"]);
                    }
                    setDoctors(data);
...
_s(FindDoctorsContent, "XLXts1vEWUf46hL/is2SyBPksWA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
...
__turbopack_context__.k.register(_c1, "FilterControls");
__turbopack_context__.k.register(_c2, "DoctorCard");
__turbopack_context__.k.register(_c3, "FindDoctorsContent");
__turbopack_context__.k.register(_c4, "FindDoctorsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_bd8963cb._.js.map