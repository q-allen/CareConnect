...
"[project]/app/(patient)/patient/certificates/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CertificatesPage() {
    ...
    const loadData = async ()=>{
        try {
            ...
            const [reqRes, certRes] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$medicalRecordsService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["medicalRecordsService"].getCertificateRequests(),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$medicalRecordsService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["medicalRecordsService"].getCertificates("")
            ]);
            if (reqRes.success) setRequests(reqRes.data);
            if (certRes.success) setCertificates(certRes.data);
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : "Failed to load data");
        } finally{
            setLoading(false);
        }
    };
    ...
    const downloadPdf = (certId)=>{
        const url = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBaseUrl"])()}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].CERTIFICATE_PDF(certId)}`;
...
_s(CertificatesPage, "pb7qs3tSDICx/RPxoJeVlXtJ8WE=");
_c = CertificatesPage;
var _c;
...
//# sourceMappingURL=_7fc35bbb._.js.map