...
const chatService = {
   ...
   */ async markAsRead (conversationId, _userId) {
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].MESSAGES(conversationId)}`);
        } catch (err) {
        // Ignore — best effort
        }
        return {
...
function ChatWindow({ conversation, appointment, onBack, onStartVideoCall }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatWindow.useEffect": ()=>{
            ...
            const wsUrl = `${url.toString().replace(/\/$/, '')}/ws/chat/${conversation.id}/`;
    ...
    const handleSend = async (e)=>{
        ...
        try {
            if (msgType === 'text' && wsReady) {
                ...
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].sendMessage(conversation.id, user.id, user.role, content, msgType, fileToSend?.file);
                if (res.success) {
                    if (optimisticMsg) {
...
_s(ChatWindow, "XlpanPw+6IvBPtkRczVcRqihOsg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChatStore"]
                ...
                if (res.success) {
                    ...
                    if (activeConversation) {
                        const updated = res.data.find({
                            "MessagesContent.useCallback[fetchConversations].updated": (c)=>c.id === activeConversation.id
...
_s(MessagesContent, "oXskOAJcwhMFfNCyC4NKnWSgLWA=", false, function() {
    return [
...
//# sourceMappingURL=_4abbf0eb._.js.map