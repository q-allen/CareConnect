...
const ENABLE_QUEUE_MOCKS = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_QUEUE_MOCKS === 'true';
const MOCK_PATIENTS_PLACEHOLDER = [];
const complaintPool = [
...
function DoctorQueuePage() {
    ...
    const seedQueue = async ()=>{
        ...
        await Promise.all(MOCK_PATIENTS_PLACEHOLDER.slice(0, 3).map(async (patient, index)=>{
        ...
        "DoctorQueuePage.useEffect": ()=>{
            ...
            const interval = setInterval({
                "DoctorQueuePage.useEffect.interval": ()=>{
                    ...
                    const pool = MOCK_PATIENTS_PLACEHOLDER.filter({
                    ...
                    const patient = (pool.length ? pool : MOCK_PATIENTS_PLACEHOLDER)[Math.floor(Math.random() * (pool.length || MOCK_PATIENTS_PLACEHOLDER.length))];
                    if (!patient) return;
    ...
    const handleStartConsultation = async (appointment)=>{
        ...
        try {
            ...
            if (target.status !== 'in-progress' && target.status !== 'in_progress') {
                const updatedApt = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$queue$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startConsult"])(target.id);
...
_s(DoctorQueuePage, "MqybO/UuDLq5mYD1PZfZQuUK5mU=", false, function() {
    return [
...
//# sourceMappingURL=_ff482aeb._.js.map