...
function VideoConsultModal({ open, appointment, onClose, onEnd, onSendPrescription, onSendLab, onSendCertificate, videoRoomUrl }) {
    ...
    if (!open) return null;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "fixed inset-0 z-50 flex bg-gray-950",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/features/doctor/patients/actions.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$patients$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/doctor/patients/actions.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function DoctorPatientsPage() {
    ...
    const [patientDetails, setPatientDetails] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Map());
    ...
    const patientSummaries = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DoctorPatientsPage.useMemo[patientSummaries]": ()=>{
            ...
            patientDetails.forEach({
                "DoctorPatientsPage.useMemo[patientSummaries]": (p, id)=>{
    ...
    const ensureConversationId = async (patientId)=>{
        if (!user) return null;
        const convRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["chatService"].createConversation(patientId, user.id, 'doctor');
    ...
    const handleStartVideo = async (summary)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$appointments$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startVideo"])(apt.id);
        setVideoAppointment(apt);
        setVideoOpen(true);
    };
    const handleAddNote = async ()=>{
        if (!selected || !user || !noteInput.trim()) return;
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$patients$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addPatientNote"])(selected.patient.id, user.id, noteInput.trim());
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                ...
                                                onClick: ()=>{
                                                    ...
                                                    setActiveTab('history');
                                                    setDetailOpen(true);
                                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$doctor$2f$patients$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPatientHistory"])(summary.patient.id, doctor?.id ?? '');
                                                },
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$user$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__User$3e$__["User"], {
                                                        className: "h-3.5 w-3.5"
...
_s(DoctorPatientsPage, "EozD9Jt4Rrcg86l8sawF6B/GNmk=", false, function() {
    return [
...
//# sourceMappingURL=_a925f06f._.js.map