 ...
 *
 * Step 2 of the booking flow — exact NowServing.ph field order:
 *
...
;
// ── helpers ───────────────────────────────────────────────────────────────────
/** Compute age (years) from an ISO date string. */ function computeAge(dob) {
    if (!dob) return "";
...
/** Build a full name string from parts. */ function buildFullName(first, middle, last) {
    return [
        first,
        middle,
        last
...
function PatientDetailsStep() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (user?.email && !patientDetails.accountEmail) {
            setPatientDetails({
                ...
                // Also pre-fill patient profile fields from user profile
                firstName: user.firstName ?? patientDetails.firstName,
                lastName: user.lastName ?? patientDetails.lastName,
                email: user.email,
                sex: user.gender || patientDetails.sex,
                dateOfBirth: user.birthdate ?? patientDetails.dateOfBirth
            });
        }
    ...
    // Keep legacy computed fields in sync so the booking flow still works
    ...
    const set = (field, value)=>syncLegacy({
            [field]: value
        });
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-6",
...
function BookingContent() {
    ...
    const finalizeFromCheckout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            ...
            const appointmentRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$appointmentService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["appointmentService"].createAppointment({
                ...
                date: draft.date,
                time: draft.time,
                type: isConsultNow ? 'on_demand' : draft.type,
    ...
    const canProceedFromStep2 = patientDetails.reasonForConsultation.trim() && patientDetails.firstName.trim() && patientDetails.lastName.trim() && patientDetails.dateOfBirth && patientDetails.email.trim() && patientDetails.sex && patientDetails.homeAddress.trim();
    ...
    const bookInClinic = async ()=>{
        ...
        try {
            ...
            const appointmentRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$appointmentService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["appointmentService"].createAppointment({
                ...
                date: selectedDate,
                time: selectedTimeSlot.startTime,
                type: isConsultNow ? 'on_demand' : 'in-clinic',
                symptoms: patientDetails.symptoms,
                familyMemberId: patientDetails.familyMemberId,
                bookedForName: patientDetails.isForSelf ? '' : patientDetails.fullName,
                bookedForAge: patientDetails.isForSelf ? null : Number(patientDetails.age) || null,
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        isConsultNow && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(Badge, {
...
//# sourceMappingURL=_76125f7a._.js.map