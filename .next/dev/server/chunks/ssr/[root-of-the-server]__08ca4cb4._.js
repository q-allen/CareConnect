...
function SignInPage() {
    ...
    const handleLogin = async (event)=>{
        ...
        setIsLoading(true);
        try {
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authService"].login({
                email,
                password
            });
            setUser(user);
            ...
            toast({
                title: "Login failed",
                description: err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"] ? err.message : "Something went wrong.",
                variant: "destructive"
            });
        } finally{
            setIsLoading(false);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__08ca4cb4._.js.map