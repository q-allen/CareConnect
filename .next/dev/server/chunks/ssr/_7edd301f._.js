...
function FileCard({ type, title, description, doctorName, doctorSpecialty, doctorAvatar, date, isNew, statusBadge, hasPrescriptionMeds, pdfUrl, fileUrl, index = 0, onClick }) {
    ...
    const resolveUrl = (url)=>{
        ...
        return `${("TURBOPACK compile-time value", "http://localhost:8000") ?? ''}${url}`;
    };
    const handleDownload = async (e)=>{
        ...
        try {
            const res = await fetch(resolveUrl(effectiveUrl), {
                credentials: 'include'
            });
    ...
    const handlePrint = ()=>{
        if (resolvedFileUrl) {
            ...
            try {
                ...
                toast({
                    title: 'Print ready',
                    description: 'Use your browser print dialog.'
                });
            }
        } else {
...
//# sourceMappingURL=_7edd301f._.js.map