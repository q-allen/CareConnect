    ...
    const handleSend = async (e)=>{
        ...
        try {
            if (msgType === 'text' && wsReady) {
                ...
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["chatService"].sendMessage(conversation.id, user.id, user.role, content, msgType, fileToSend?.file);
                if (res.success) {
                    if (optimisticMsg) {
        ...
        try {
            ...
            if (res.success) {
                ...
                if (activeConversation) {
                    const updated = res.data.find((c)=>c.id === activeConversation.id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a0f24fad._.js.map