...
function ChatWindow({ conversation, appointment, onBack, onStartVideoCall }) {
    ...
    const { messages, addMessage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useChatStore"])();
    ...
    const handleSend = async (e)=>{
        ...
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["chatService"].sendMessage(conversation.id, user.id, user.role, content, type);
        if (res.success) {
            addMessage(res.data);
            ...
            if (user.role === 'patient') {
                ...
                setTimeout(async ()=>{
                    setIsTyping(false);
                    const docRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["chatService"].sendMessage(conversation.id, conversation.doctorId, 'doctor', getAutoResponse(content));
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            appointment && appointment.type === 'online' && [
                'confirmed',
                'pending'
            ].includes(appointment.status) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function MessagesPage() {
    ...
    const handleVideoCallEnd = (endedAt)=>{
        ...
        if (activeConversation && user) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["chatService"].sendMessage(activeConversation.id, activeConversation.doctorId, 'doctor', '📋 Video consultation ended. Your prescription has been sent to your pharmacy. Get well soon!', 'text').then((res)=>{
                if (res.success) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$chatService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["chatService"].getMessages(activeConversation.id).then((msgRes)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c466a0f6._.js.map