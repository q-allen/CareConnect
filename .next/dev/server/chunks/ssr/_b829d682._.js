...
function DoctorAppointmentsPage() {
    ...
    const fetchAppointments = async ()=>{
        ...
        if (aptsRes.success) {
            ...
            const enriched = aptsRes.data.map((apt)=>({
                    ...
                    patient: patientMap.get(apt.patientId) ?? apt.patient
                }));
    ...
    const handleStartVideo = async (apt)=>{
        ...
        try {
            ...
            updateAppointment(apt.id, {
                status: updated?.appointment?.status ?? 'in_progress',
                videoRoomUrl: updated?.videoRoomUrl ?? apt.videoRoomUrl
            });
            setSelected({
                ...apt,
                status: 'in_progress',
                    ...
                    children: [
                        ...
                        selected && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                selected.symptoms && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_b829d682._.js.map