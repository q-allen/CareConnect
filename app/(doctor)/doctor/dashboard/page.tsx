...
import {
  ...
  Shield, Stethoscope, Activity, CheckCircle2, TrendingUp, DollarSign,
} from 'lucide-react';
 ...
 * 
 * UX Improvements:
 * - Clean welcome with personalized greeting (Good morning/afternoon)
 * - Today's summary cards (Appointments, On-demand requests, Earnings)
 * - Quick actions grid with visual icons
 * - Now Serving section with patient card
 * - Upcoming appointments preview
 * - On-demand toggle with live status
 */
  ...
  return (
    <div className="space-y-6 p-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center gap-3 p-4 rounded-xl bg-muted/50 border border-border text-sm text-muted-foreground">
        ...
        <p>
          Your consultations, notes, and documents are <span className="font-medium text-foreground">encrypted and private</span>. 
